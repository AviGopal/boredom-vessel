...
export declare const vesselAdditionScaffoldDispatchTemplate: VesselAdditionTemplateDefinition;
export default vesselAdditionScaffoldDispatchTemplate;
//# sourceMappingURL=vessel-addition-scaffold-dispatch.d.ts.map